...
UPDATE employee SET pwd=MD5(123);
...
SELECT * FROM login WHERE empId=1 AND pwd=1
...
INSERT INTO bill VALUES(NULL,'7eeb212b-bbe0-4842-a203-31c6cb836f3e',3,4,144,2,NOW(),'未结账')
DROP TABLE bill;
...
SELECT * FROM employee
SELECT * FROM menu;
SELECT bill.*,NAME AS name2 FROM bill,menu WHERE bill.`menuId`=menu.`id`
