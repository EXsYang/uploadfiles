...
![image-20240725185214275](https://raw.githubusercontent.com/EXsYang/PicGo-images-hosting/main/images/image-20240725185214275.png)
...
**examples**	例子	/ɪgˈzɑːmplz/	example的复数

**dashboard**	仪表板	/ˈdæʃbɔːd/

**count**	计数

**Decompiler**	反编译

**monitor**	监视器	/ˈmɒnɪtə(r)/

**watch**	监视；手表；观察；表；注意；	/wɒtʃ/

**trace**	/treɪs/	追踪；追溯；发现；找到；

**sample**	样品，样本，试样；(抽查的)样本；	/ˈsɑːmpl/

**simple**	简单的；简单的，一般的；	/ˈsɪmpl/		



**java mission control**	Java 任务控制	**JMC**

**mission**	 任务; 使命	/ˈmɪʃn/

**scavenge**	拾荒；吃(动物尸体)；(从废弃物中)觅食；捡破烂	/ˈskævɪndʒ/

![image-20240721222052317](C:/Users/yangd/AppData/Roaming/Typora/typora-user-images/image-20240721222052317.png)

**allocation profiling**	分配分析



**adaptive**	适应的；有适应能力的	/əˈdæptɪv/

**policy**	/ˈpɒləsi/	策略;  政策；方针；原则；

![image-20240723134750788](https://raw.githubusercontent.com/EXsYang/PicGo-images-hosting/main/images/image-20240723134750788.png)



GUI 是 "Graphical User Interface" 的缩写，中文意思是图形用户界面。

**Graphical** 	/ˈɡræfɪkl/	图形；图形化；图形方式 



**manageable**	可管理的；可处理的；可操纵的	/ˈmænɪdʒəbl/

查看可以使用`jinfo -flag` 在程序运行起来之后可以修改的参数：

![image-20240723180825804](https://raw.githubusercontent.com/EXsYang/PicGo-images-hosting/main/images/image-20240723180825804.png)
...
**peak**	/piːk/	高峰时期的；巅峰状态的；最高度的

![image-20240725201837295](https://raw.githubusercontent.com/EXsYang/PicGo-images-hosting/main/images/image-20240725201837295.png)
...
**overhead**	/ˌəʊvəˈhed /	n. 开销；经常费用；经常开支；	adv. 在空中；在头上方

**limit** 	/ˈlɪmɪt/	限制；(地区或地方的)境界，界限，范围；极限；

**exceeded**	/ɪkˈsiːdɪd/	超过(数量)；	exceed的过去分词和过去式

![image-20240726110254487](https://raw.githubusercontent.com/EXsYang/PicGo-images-hosting/main/images/image-20240726110254487.png)



**Ergonomics**	/ˌɜːɡəˈnɒmɪks/	人体工程学；人体工学；工效学；人机工程；人类工程学

![image-20240726113457787](https://raw.githubusercontent.com/EXsYang/PicGo-images-hosting/main/images/image-20240726113457787.png)





**intelligence**	智力；(尤指关于敌对国家的)情报；智慧；情报人员；才智
记忆
...
**cost**	费用；成本；(为做某事涉及的)努力，代价，损失；花费；价钱；诉讼费用	/kɒst/

![image-20240730191227591](https://raw.githubusercontent.com/EXsYang/PicGo-images-hosting/main/images/image-20240730191227591.png)
...
![image-20240801181628956](https://raw.githubusercontent.com/EXsYang/PicGo-images-hosting/main/images/image-20240801181628956.png)





**shenandoah**	/ˌʃɛnənˈdoʊə/	谢南多厄；谢南多亚，美国的一条河的名称
...
![image-20240811192955877](https://raw.githubusercontent.com/EXsYang/PicGo-images-hosting/main/images/image-20240811192955877.png)



**perform**	/pəˈfɔːm/	执行；工作，运转(好 / 不好)；履行；表演；演出；做
记忆
per- 完全,贯穿 + form 形状
...
**circle**	圆圈；环形	 [ˈsɜːrkl]

**Request Cancellation**	请求取消服务d
...
adj.
有弹性的；灵活的；可伸缩的；有弹力的；橡皮圈(或带)的；可改变的
n.
橡皮圈(或带)；松紧带
...
**reentrant**	英/riːˈɛntrənt/美/ˌriˈɛntrənt/		可重入；可重入的；重入；可再入的

**condition**	/kənˈdɪʃn/ 	条件；物质环境，状态，条件；

**signal**	信号；(尤指铁路和公路上的)指示灯，信号灯，红绿灯；标志；预示；暗号
