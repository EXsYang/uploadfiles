...
非聚簇索引（Non-clustered Index）意味着**索引结构**和**数据本身**是分开存储的。索引结构只包含键值和指向数据实际存储位置的指针，而不是像聚簇索引那样直接存储数据记录。
...
![1695056531776](assets\1695056531776.png) 
...
![1695056622789](assets\1695056622789.png) 
